...
.nav-cta{
  ...
  color:var(--gold);font-size:13.5px;font-weight:500;transition:all .2s;
}
...
@media(max-width:720px){.nav-links a:not(.nav-cta):not(.nav-signin){display:none}}
...
.btn-primary{
  ...
  box-shadow:0 6px 24px -8px rgba(201,162,39,.5);
}
...
.btn-ghost{
  ...
  color:var(--text-dim);border:1px solid var(--line);transition:all .2s;
}
...
.tier-btn{display:block;text-align:center;padding:12px;border-radius:8px;font-size:14px;font-weight:500;transition:all .2s;border:1px solid var(--line);color:var(--text)}
...
.tiers-foot a{color:var(--gold);border-bottom:1px solid rgba(201,162,39,.4)}
        ...
        <main id="top">
          ...
          <section className="section" id="pricing">
            <div className="wrap">
              ...
              <p className="tiers-foot">Not ready to commit? <a href="/onboarding/plan">Start a free 7-day trial</a> — no card required.</p>
            </div>
          </section>
