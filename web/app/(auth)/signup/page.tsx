    ...
    return (
      <div className="min-h-screen bg-navy flex items-center justify-center px-4">
        <div className="w-full max-w-sm bg-white rounded-2xl p-8 text-center shadow-xl">
          <div className="w-12 h-12 rounded-full bg-[var(--green-lt)] flex items-center justify-center mx-auto mb-4">
            <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="var(--green)" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 className="text-[18px] font-semibold text-[var(--text)] mb-2">Check your email</h2>
    ...
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-xl">
          <h2 className="text-[16px] font-semibold text-[var(--text)] mb-5">Create your account</h2>
